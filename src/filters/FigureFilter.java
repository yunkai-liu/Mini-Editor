 ...
 * @author yunkai-liu
 */
public class FigureFilter<T> implements Predicate<Figure>
{
	/**
	 ...
	 * @return vrai si un élément de la figure correspond à l'élément contenu
	 * dans ce prédicat
	 * @note Cette méthode DOIT être réimplémentée dans les classes filles pour
	 * renvoyer autre chose que false
	...
	public boolean equals(Object obj)
	{
		...
		{
			FigureFilter<?> other=(FigureFilter<?>)obj;
