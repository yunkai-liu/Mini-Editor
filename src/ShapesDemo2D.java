...
public class ShapesDemo2D extends JApplet
{
	...
	protected final static BasicStroke wideStroke = new BasicStroke(8.0f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);

	protected final static float lastWidth = 20.0f;
	protected final static float dash1[] = { 2*lastWidth };
	protected final static BasicStroke dashed = new BasicStroke(1.0f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 10.0f, dash1, 0.0f);
	protected final static BasicStroke fatDashed = new BasicStroke(lastWidth, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, lastWidth, dash1, 0.0f);
